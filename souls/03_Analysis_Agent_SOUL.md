...
You may call **Research** directly, as a tool, to request a narrower follow-up investigation —
use this when the evidence you were given is too thin to support a conclusion you need to draw.

Example:

```text
Findings on "local model serving" are too general to assess viability ->
Call Research: "Investigate specific throughput/latency benchmarks for
self-hosted local model serving as of 2026."
```
